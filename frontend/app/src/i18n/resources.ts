...
export const NAMESPACES = ['common', 'nav', 'marketing', 'auth', 'cases', 'labs', 'reference'] as const;
export type Namespace = (typeof NAMESPACES)[number];

export const defaultNS = 'common';

export const resources = {
  en: { common: enCommon, nav: enNav, marketing: enMarketing, auth: enAuth, cases: enCases, labs: enLabs, reference: enReference },
  ru: { common: ruCommon, nav: ruNav, marketing: ruMarketing, auth: ruAuth, cases: ruCases, labs: ruLabs, reference: ruReference },
} as const;
